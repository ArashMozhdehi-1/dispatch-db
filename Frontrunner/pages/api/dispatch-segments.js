...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('🔍 Fetching dispatch lane segments with limit:', limit);
    
    const countResult = await dispatchPool.query(`
    ...
    console.error('❌ Error fetching dispatch segments:', error);
