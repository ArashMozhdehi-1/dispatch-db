...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      console.log(`[API] Returning ${road_corner_markers.length} corner markers and ${road_side_markers.length} side markers`);
      ...
      res.status(200).json({
        ...
        road_corner_markers: road_corner_markers || [], // Ensure it's always an array
        road_side_markers: road_side_markers || [], // Ensure it's always an array
      });
    } finally {
      client.release();
    }
